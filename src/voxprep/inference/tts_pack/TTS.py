...
import yaml
from voxprep.training.AR.models.t2s_lightning_module import Text2SemanticLightningModule
# BigVGAN only needed for v3 (lazy-imported inside init_vocoder)
from voxprep.extract.cnhubert import CNHubert
from voxprep.extract.module.mel_processing import mel_spectrogram_torch, spectrogram_torch
from voxprep.extract.module.models import SynthesizerTrn, SynthesizerTrnV3, Generator
from peft import LoraConfig, get_peft_model
from voxprep.training.process_ckpt import get_sovits_version_from_path_fast, load_sovits_new
from transformers import AutoModelForMaskedLM, AutoTokenizer

# AP_BWE (audio super-resolution) only needed if if_sr=True — lazy-imported
from voxprep.training.i18n.i18n import I18nAuto, scan_language_list
from .text_segmentation_method import splits
from .TextPreprocessor import TextPreprocessor
from voxprep.inference.sv import SV
...
class TTS:
    def __init__(self, configs: Union[dict, str, TTS_Config]):
        ...
        self.vocoder = None
        self.sr_model = None  # lazy: AP_BWE type
        self.sv_model = None
    ...
    def init_vocoder(self, version: str):
        if version == "v3":
            ...
            from BigVGAN.bigvgan import BigVGAN  # lazy: only v3
    ...
    def init_sr_model(self):
        if self.sr_model is not None:
            return
        try:
            from tools.audio_sr import AP_BWE  # lazy: only if if_sr=True
